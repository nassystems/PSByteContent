& {
$result = Dump-ByteContent -Encoding ([System.Text.Encoding]::ASCII) -InputObject $samplebytelist[$sampleindex]
...
$result = Dump-ByteContent -StartAddress 0x00000001 -Encoding ([System.Text.Encoding]::ASCII) -InputObject $samplebytelist[$sampleindex]
...
$result = Dump-ByteContent -StartAddress 0x0000000f -Encoding ([System.Text.Encoding]::ASCII) -InputObject $samplebytelist[$sampleindex]
Assert ($result -join "`n" -ceq (@'
00000000 :                                                65 : e
...
$result = Dump-ByteContent -StartAddress 0x00000010 -Encoding ([System.Text.Encoding]::ASCII) -InputObject $samplebytelist[$sampleindex]
Assert ($result -join "`n" -ceq (@'
...
$result = Dump-ByteContent -StartAddress 0x00000011 -Encoding ([System.Text.Encoding]::ASCII) -InputObject $samplebytelist[$sampleindex]
Assert ($result -join "`n" -ceq (@'
...
$result = Dump-ByteContent -BytesPerLine 24 -Encoding ([System.Text.Encoding]::ASCII) -InputObject $samplebytelist[$sampleindex]
Assert ($result -join "`n" -ceq (@'
...
$result = Dump-ByteContent -StartAddress 0x00000017 -BytesPerLine 24 -Encoding ([System.Text.Encoding]::ASCII) -InputObject $samplebytelist[$sampleindex]
Assert ($result -join "`n" -ceq (@'
00000000 :                                                                          65 : e
...
$result = Dump-ByteContent -StartAddress 0x00000018 -BytesPerLine 24 -Encoding ([System.Text.Encoding]::ASCII) -InputObject $samplebytelist[$sampleindex]
Assert ($result -join "`n" -ceq (@'
...
$result = Dump-ByteContent -StartAddress 0x00000019 -BytesPerLine 24 -Encoding ([System.Text.Encoding]::ASCII) -InputObject $samplebytelist[$sampleindex]
Assert ($result -join "`n" -ceq (@'
