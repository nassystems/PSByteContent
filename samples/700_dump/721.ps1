& {
$result = $arraywrapper | Dump-ByteContent -Encoding ([System.Text.Encoding]::ASCII)
...
$result = $arraywrapper | Dump-ByteContent -StartAddress 0x00000001 -Encoding ([System.Text.Encoding]::ASCII)
Assert ($result -join "`n" -ceq (@'
...
$result = $arraywrapper | Dump-ByteContent -StartAddress 0x0000000f -Encoding ([System.Text.Encoding]::ASCII)
Assert ($result -join "`n" -ceq (@'
00000000 :                                                ac : ?
...
$result = $arraywrapper | Dump-ByteContent -StartAddress 0x00000010 -Encoding ([System.Text.Encoding]::ASCII)
Assert ($result -join "`n" -ceq (@'
...
$result = $arraywrapper | Dump-ByteContent -StartAddress 0x00000011 -Encoding ([System.Text.Encoding]::ASCII)
Assert ($result -join "`n" -ceq (@'
...
$result = $arraywrapper | Dump-ByteContent -BytesPerLine 24 -Encoding ([System.Text.Encoding]::ASCII)
Assert ($result -join "`n" -ceq (@'
...
$result = $arraywrapper | Dump-ByteContent -StartAddress 0x00000017 -BytesPerLine 24 -Encoding ([System.Text.Encoding]::ASCII)
Assert ($result -join "`n" -ceq (@'
00000000 :                                                                          ac : ?
...
$result = $arraywrapper | Dump-ByteContent -StartAddress 0x00000018 -BytesPerLine 24 -Encoding ([System.Text.Encoding]::ASCII)
Assert ($result -join "`n" -ceq (@'
...
$result = $arraywrapper | Dump-ByteContent -StartAddress 0x00000019 -BytesPerLine 24 -Encoding ([System.Text.Encoding]::ASCII)
Assert ($result -join "`n" -ceq (@'
