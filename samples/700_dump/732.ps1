& {
$result = $arraywrapper | Dump-ByteContent -Encoding ([System.Text.Encoding]::UTF8)
...
00000070 : af 8b 0a b8 55 f1 4f e2 - 43 c9 9e e1 5e 5a 33 42 : ��␊�U�O�Cɞ�^Z3B
'@ -replace '\r?\n', "`n"))

$result = $arraywrapper | Dump-ByteContent -StartAddress 0x00000001 -Encoding ([System.Text.Encoding]::UTF8)
Assert ($result -join "`n" -ceq (@'
...
00000070 : 11 af 8b 0a b8 55 f1 4f - e2 43 c9 9e e1 5e 5a 33 : ␑��␊�U�O�Cɞ�^Z3
00000080 : 42                                                : B
'@ -replace '\r?\n', "`n"))

$result = $arraywrapper | Dump-ByteContent -StartAddress 0x0000000f -Encoding ([System.Text.Encoding]::UTF8)
Assert ($result -join "`n" -ceq (@'
00000000 :                                                ac : �
...
00000040 : 7b ed bd 24 1c 9e 7d 13 - bc 0b ea 1b e7 e0 08 d7 : {�$␜�}␓�␋�␛��␈�X
00000050 : 58 8e 13 14 15 7a 2a aa - 54 d9 09 b7 ce 80 5c c5 : �␓␔␕z*�T�␉�΀\�
...
00000080 : 8b 0a b8 55 f1 4f e2 43 - c9 9e e1 5e 5a 33 42    : �␊�U�O�Cɞ�^Z3B
'@ -replace '\r?\n', "`n"))

$result = $arraywrapper | Dump-ByteContent -StartAddress 0x00000010 -Encoding ([System.Text.Encoding]::UTF8)
Assert ($result -join "`n" -ceq (@'
...
00000080 : af 8b 0a b8 55 f1 4f e2 - 43 c9 9e e1 5e 5a 33 42 : ��␊�U�O�Cɞ�^Z3B
'@ -replace '\r?\n', "`n"))

$result = $arraywrapper | Dump-ByteContent -StartAddress 0x00000011 -Encoding ([System.Text.Encoding]::UTF8)
Assert ($result -join "`n" -ceq (@'
...
00000080 : 11 af 8b 0a b8 55 f1 4f - e2 43 c9 9e e1 5e 5a 33 : ␑��␊�U�O�Cɞ�^Z3
00000090 : 42                                                : B
'@ -replace '\r?\n', "`n"))

$result = $arraywrapper | Dump-ByteContent -BytesPerLine 24 -Encoding ([System.Text.Encoding]::UTF8)
Assert ($result -join "`n" -ceq (@'
...
00000060 : 28 ff 17 16 08 e3 34 b4 - c0 4c 07 27 6f 1e 2a 11 - af 8b 0a b8 55 f1 4f e2 : (�␗␖␈�4��L␇'o␞*␑��␊�U�O�C
00000078 : 43 c9 9e e1 5e 5a 33 42                                                     : ɞ�^Z3B
'@ -replace '\r?\n', "`n"))

$result = $arraywrapper | Dump-ByteContent -StartAddress 0x00000017 -BytesPerLine 24 -Encoding ([System.Text.Encoding]::UTF8)
Assert ($result -join "`n" -ceq (@'
00000000 :                                                                          ac : �
...
00000090 : c9 9e e1 5e 5a 33 42                                                        : ɞ�^Z3B
'@ -replace '\r?\n', "`n"))

$result = $arraywrapper | Dump-ByteContent -StartAddress 0x00000018 -BytesPerLine 24 -Encoding ([System.Text.Encoding]::UTF8)
Assert ($result -join "`n" -ceq (@'
...
00000078 : 28 ff 17 16 08 e3 34 b4 - c0 4c 07 27 6f 1e 2a 11 - af 8b 0a b8 55 f1 4f e2 : (�␗␖␈�4��L␇'o␞*␑��␊�U�O�C
00000090 : 43 c9 9e e1 5e 5a 33 42                                                     : ɞ�^Z3B
'@ -replace '\r?\n', "`n"))

$result = $arraywrapper | Dump-ByteContent -StartAddress 0x00000019 -BytesPerLine 24 -Encoding ([System.Text.Encoding]::UTF8)
Assert ($result -join "`n" -ceq (@'
...
00000090 : e2 43 c9 9e e1 5e 5a 33 - 42                                                : �Cɞ�^Z3B
'@ -replace '\r?\n', "`n"))
}
